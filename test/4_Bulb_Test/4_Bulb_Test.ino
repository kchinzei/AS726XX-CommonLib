...
void loop() {
  ...
  Serial.print(i++); Serial.println(". Set white 12.5mA");
  ...
  Serial.print(i++); Serial.println(". Turn off white!");
  ...
  Serial.print(i++); Serial.println(". Set white 25mA");
  sensor.setBulbCurrent(AS7265X_LED_CURRENT_LIMIT_25MA, AS7265x_LED_WHITE);
  delay(1000);

  Serial.print(i++); Serial.println(". Set white 50mA");
